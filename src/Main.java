...
public class Main {
    ...
    private static final String PATH = "C:\\Users\\Пользователь\\IdeaProjects\\HomeWorkFilesTask2\\Games\\savegames";
   // private static final String PATH = "./src/main/java/ru/netology/core/homework03/Games/savegames";
    public static void main(String[] args) {
        GameProgress game1 = new GameProgress(100, 2, 80, 6.2);
        GameProgress game2 = new GameProgress(70, 4, 70, 4.6);
        GameProgress game3 = new GameProgress(40, 6, 30, 5.8);
